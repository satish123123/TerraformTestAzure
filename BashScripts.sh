...
az login
az account set --subscription "Visual Studio-Shaikh-Lab"
...
az keyvault create --name "satishdevopskv" --resource-group "satishdevops-infra" --location uksouth
az keyvault secret set --vault-name "satishdevopskv" --name "tstateaccess" --value {$ACCOUNT_KEY}
az keyvault secret show --vault-name "satishdevopskv" --name "tstateaccess"
